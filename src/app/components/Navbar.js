...
export default function Navbar({theme}){
    ...
    return ( 
        <nav className="flex sticky flex-col justify-between z-30 top-0  ">
            <div className={" bg-white-0 shadow-lg shadow-8 text-md top-0 bg-white-2 h-[75px] min-w-[100%] flex justify-center items-center p-6 gap-14  font-semibold text-theme-1  "}>
                ...
                <div className="flex justify-center items-center absolute right-12 gap-12">
                    ...
                    <button onClick={()=> logout()} className="w-[125px] h-[50px] bg-theme-2 duration-500 rounded-full hover:cursor-pointer text-theme-0 font-bold hover:scale-110" >Logout</button>  
                </div>
