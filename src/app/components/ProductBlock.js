...
export default function ProductBlock({productName, productCost, productImage, productType, productId}){
    ...
    return (
        <div onKeyDown={()=> router.push(`/product/${productId}`)   } onClick={()=> router.push(`/product/${productId}`) } className="hover:cursor-pointer hover:shadow-2xl duration-500 shadow-lg w-[250px] h-auto rounded-md shadow-8 hover:scale-110 font-ubuntu">
